...
[![Steve Yegge](https://miro.medium.com/v2/resize:fill:64:64/1*8Ae2b9dv-sQtme8C4_sjhA.jpeg)](https://medium.com/?source=post_page---byline--eda6e4f07163---------------------------------------)

[Steve Yegge](https://medium.com/?source=post_page---byline--eda6e4f07163---------------------------------------)
...
[nameless link](https://medium.com/m/signin?actionUrl=https%3A%2F%2Fmedium.com%2F_%2Fvote%2Fp%2Feda6e4f07163&operation=register&redirect=https%3A%2F%2Fsteve-yegge.medium.com%2Fthe-ai-vampire-eda6e4f07163&user=Steve+Yegge&userId=c1ec701babb7&source=---header_actions--eda6e4f07163---------------------clap_footer------------------)

--

90

[nameless link](https://medium.com/m/signin?actionUrl=https%3A%2F%2Fmedium.com%2F_%2Fbookmark%2Fp%2Feda6e4f07163&operation=register&redirect=https%3A%2F%2Fsteve-yegge.medium.com%2Fthe-ai-vampire-eda6e4f07163&source=---header_actions--eda6e4f07163---------------------bookmark_footer------------------)
...
![The AI Vampire Extraction Apparatus](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*svqMSkVB3MnkjOetkxoLCQ.png)
...
But if you haven’t used _specifically_ Opus 4.5/4.6 with _specifically_ Claude Code for at least an hour, then you’re in for a real shock. Because all your complaining about AI not being useful for real-world tasks is obsolete. AI coding hit an event horizon on November 24th, 2025. It’s the real deal. And unfortunately, all your other tools and models are pretty terrible in comparison.
...
With a 10x boost, if you give an engineer Claude Code, then once they’re fluent, their work stream will produce nine _additional_ engineers’ worth of value.
...
In that scenario, your employer captures 100% of the value from _you_ adopting AI. You get nothing, or at any rate, it ain’t gonna be 9x your salary. And everyone hates you now.

And you’re _exhausted._ You’re tired, Boss. You got nothing for it.
...
In this scenario, _you_ capture 100% of the value from your adopting AI.
...
![The Battle for Value Capture](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*by0LJurBrgQEatMzTnI2gQ.png)
...
*   Panicking CEOs are leaning in _hard_ to AI, often whiplashing it into their orgs.
...
Maybe me worst of all. I have 40 years of experience, I’ve led large teams, I read fast, and I have essentially unlimited time, energy, and now tokens for experimenting. I am _completely_ unrepresentative of the average developer.
...
![Chaos emerging as 10x mania consumes the city](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*ffpMYJ72WZlynenWObMU0w.png)
...
I know this because they are literally telling me their plans like villains at the end of an old movie, since with [Gas Town](https://medium.com/welcome-to-gas-town-4f25ee16dd04) I have mastered the illusion of knowing what I’m doing. Truth is, nobody, least of all me, knows what they’re doing right now. But I _look_ like I do, so everyone is coming to show me their almost uniformly terrible ideas.
...
![An army of startup-prolecats with vampire bugs](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*eWd9b4N5st7Mld-kUYvoEw.jpeg)

Enterprises see the oncoming horde and think, oh jeez, we need to hustle. And they’re not exactly wrong. Which means this lovely dystopian picture is making its way slowly but surely into enterprise, at the big company where _you_ work.
...
![captionless image](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*57IEwJyF0kHhMAxKGxnXlw.png)
...
You might think you don’t. And indeed, _individually_ you may not have much sway over it. But _collectively_, the employees of your company have literally all the power. Now that I’ve been up at the top, I’ve learned that CEOs have _surprisingly_ little power.
...
They found a _great_ setting for the dial, at least for this time and place. I don’t know how it changes with AI. But I feel like their current setting is where we need to aim as the future changes us.

It’s not even _remotely_ sustainable for companies to capture 100% of the value from AI. And when employees capture 100% of the value, it will be temporary at best: that company gets beat by someone who’s got the dial turned higher.
...
But the right setting is in the middle somewhere. Companies will try to drag it higher. You need to _fight_ to drag it lower.
...
![A Cozy Town With Nap Pods](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*kNKMoakPawoO8jp4ZsKt9w.png)
...
I regret the unrealistic standards that I’m contributing to setting. I don’t believe most people can work like I’ve been working. I’m not sure how long _I_ can work how I’ve been working.
...
![The Green AI Workplace](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*EkSLKFQwHX7vVRu7n16ixQ.png)