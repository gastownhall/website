...
description: "> Understanding the three-layer architecture of polecat workers"
---
...
- [Molecules](/concepts/molecules/) - Molecule execution and polecat workflow
- [Propulsion Principle](/concepts/propulsion-principle/) - Why work triggers immediate execution
