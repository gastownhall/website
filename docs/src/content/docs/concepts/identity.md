---
title: "Agent Identity and Attribution"
description: "> Canonical format for agent identity in Gas Town"
---
...
See [reference.md](/concepts/reference#environment-variables) for the complete
...
See [polecat-lifecycle.md](/concepts/polecat-lifecycle#polecat-identity) for details.
