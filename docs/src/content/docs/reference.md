---
title: "Gas Town Reference"
description: "Technical reference for Gas Town internals. Read the README first."
---
...
Note: "Swarm" is ephemeral (workers on a convoy's issues). See [Convoys](/concepts/convoy/).
...
See [escalation.md](/design/escalation/) for full protocol.
...
**Convoy tracking**: Convoys track batched work across rigs. A "swarm" is ephemeral - just the workers currently on a convoy's issues. See [Convoys](/concepts/convoy/) for details.
