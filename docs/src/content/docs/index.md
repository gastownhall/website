---
title: "Understanding Gas Town"
description: "This document provides a conceptual overview of Gas Town's architecture, focusing on the role taxonomy and how different agents interact."
---
...
has provenance. See [Why These Features](/other/why-these-features/) for the full rationale.
...
| **Deacon** | Background supervisor daemon ([watchdog chain](/design/watchdog-chain/)) | Singleton, persistent |
...
| Role | Description | Lifecycle |
|------|-------------|-----------|
| **Polecat** | Ephemeral worker with own worktree | Transient, Witness-managed ([details](/concepts/polecat-lifecycle/)) |
...
When issues close, the convoy lands. See [Convoys](/concepts/convoy/) for details.
