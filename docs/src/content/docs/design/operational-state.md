---
title: "Operational State in Gas Town"
description: "> Managing runtime state through events and labels."
---
...
For Boot triage and degraded mode details, see [Watchdog Chain](/design/watchdog-chain/).
