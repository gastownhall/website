...
description: "Technical architecture for Gas Town multi-agent workspace management."
---
...
- [reference.md](/reference/) - Command reference
- [molecules.md](/concepts/molecules/) - Workflow molecules
- [identity.md](/concepts/identity/) - Agent identity and BD_ACTOR
